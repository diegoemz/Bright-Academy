...
<body> 
    ...
    <section class="navegador2"> 
        ...
        <nav class="nav2" aria-label="Navegación de curso">
            <a href="../cursos_profesores/curso_profe_4.php">Curso</a>
            <a href="../participantes_profesores/participantes_4_profe.php">Participantes</a>
            <a href="../calificaciones_profesores/calificaciones_profesores_4.php">Calificaciones</a>
            <a href="../upload_pages/upload_4.html">Subir Material</a>
        </nav>
    </section>
    ...
    <section class="cursos">
        <div class="cont">
            ...
            <div class="container">
                ...
                <form action="../notas_profesores/notas_profesores_4.php" method="POST">
