...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['nombre_tarea']) && isset($_POST['calificacion'])) {
        ...
        $consulta = $conexion->prepare("INSERT INTO notas_3 (nombre_archivo, nota_obtenida) VALUES (?, ?)");
...
echo "<script>window.location.href = '../calificaciones_profesores/calificaciones_profesores_3.php';</script>";
?>
