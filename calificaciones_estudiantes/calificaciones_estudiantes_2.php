...
<body> 
    ...
    <section class="navegador2"> 
        ...
        <nav class="nav2" aria-label="Navegación de curso">
            <a href="../cursos_estudiantes/curso_2.php">Curso</a>
            <a href="../participantes_estudiantes/participantes_2.php">Participantes</a>
            <a href="../calificaciones_estudiantes/calificaciones_estudiantes_2.php">Calificaciones</a>
            <a href="../upload_estudiantes/upload_est_2.html">Cargar Tareas</a>
        </nav>
    </section>
    ...
    <section class="cursos">
        <div class="cont">
            ...
            <?php include('../php_tareas/mostrar_tareas_2.php'); ?>

            <h2>Calificaciones Obtenidas</h2>
            <?php include('../mostrar_calificaciones/mostrar_calificaciones_2.php'); ?>
        </div>
    </section>
