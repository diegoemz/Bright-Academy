...
<head>
    ...
    <script src="../jsReportes/db_4.js"></script> <!-- Asegúrate de que esta ruta sea correcta -->
</head>
<body onload="obtenerEstudiantes(); graficoProgreso();">
    ...
    <section class="vista-cursos">
        ...
        <a href="../generar_pdf/generar_pdf_4.php" class="btn btn-primary">Descargar Informe en PDF</a>
