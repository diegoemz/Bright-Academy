...
<head>
    ...
    <script src="../jsReportes/db_2.js"></script> <!-- Asegúrate de que esta ruta sea correcta -->
</head>
<body onload="obtenerEstudiantes(); graficoProgreso();">
    ...
    <section class="vista-cursos">
        ...
        <a href="../generar_pdf/generar_pdf_2.php" class="btn btn-primary">Descargar Informe en PDF</a>
